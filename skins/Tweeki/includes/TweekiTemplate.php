...
?>
	<script>// Tämä scripti haistelee tweekin nav-barin paksuutta ja säätää banneri imagen marginia sen mukaan
    document.addEventListener("DOMContentLoaded", function() {
        var navbarHeight = document.querySelector('.tweeki-navbar').offsetHeight;
        var remValue = parseFloat(getComputedStyle(document.documentElement).fontSize);

        document.querySelector('.bannerMainBlock').style.marginTop = (navbarHeight / remValue) + 'rem';
        document.querySelector('..bannerSecondBlock').style.marginTop = (navbarHeight / remValue) + 'rem';
        document.querySelector('.bannerImageBlock').style.marginTop = (navbarHeight / remValue) + 'rem';
    });
    </script>
	</body>
...
?>
		...
		<!--This part takes css from style tag in header block in this file-->	
		<div  class="bannerMainBlock";> <!--custom div made by toni mäenpää  -->
			<div class="bannerSecondBlock">                     
			...
			<div class="WikiBodyStylesCustom" class="<?php echo $contentclass; ?>"><!-- old value was: id="contentwrapper"-->
...
?>
				...
				<div>
				<form>
					<input type="button" value="Go back!" style="margin:5px; display:flex;" onclick="history.back()">
					</form>
					</div>
				</div>
			</div>
	...
	public static function renderNavbar($skin) {
		...
		if ( $skin->checkVisibility( 'navbar' ) ) { ?>
			<header>
				...
				<nav id="mw-navigation" class="<?php echo $navbar_class; ?>">
					...
					<div class="<?php echo wfMessage( 'tweeki-container-class' )->plain(); ?>">
						...
						<div id="navbar" class="collapse navbar-collapse">
							...
							<?php } ?>
							<div class="dropdown" id="non-mobile"><!--test starts-->
									<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									sites by category
									</button>
									<div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/Main_Page">Home</a>
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/Start_of_project">beginning a project</a>
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/During_project">Working in a project</a>
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/End_of_project">Ending a project</a>
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/General">General topics</a>
										<a class="dropdown-item" href="https://tonymm81.kapsi.fi/mediawiki/index.php/Support">Support</a>
										
									</div>
									</div><!--test ends-->
									<div class="mobileMenu">
									<a href="https://tonymm81.kapsi.fi/mediawiki/index.php/Main_Page">Home</a></br>
										<a  href="https://tonymm81.kapsi.fi/mediawiki/index.php/Start_of_project">beginning a projec</a></br>
										<a  href="https://tonymm81.kapsi.fi/mediawiki/index.php/During_project">Working in a project</a></br>
										<a  href="https://tonymm81.kapsi.fi/mediawiki/index.php/End_of_project">Ending a project</a></br>
										<a href="https://tonymm81.kapsi.fi/mediawiki/index.php/General">General topics</a></br>
										<a  href="https://tonymm81.kapsi.fi/mediawiki/index.php/Support">Support</a></br>
									</div>
				...
				<style>/*Banner image and wiki card styles with breakpoints*/
					.mobileMenu{
						display:none;
					}
					.bannerMainBlock{/*top div in banner image  */
						max-width:2920px;
						min-height:770px; 
						margin-top: calc(25px + 2rem); 
						margin:5px;
					}
					
					.bannerSecondBlock{/*inner div in banner image  */
						position: relative;
						max-width:100%;
						max-height:100%; 
						margin-top: calc(25px + 2rem); 
					...
					.bannerImageBlock{ /**web site banner image block */
						padding:5px;
						position: relative;
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/Bannerimg.png') !important;  
					...
					.WikiBodyStylesCustom{/**Wiki body background image and customized wiki main body(20.8)*/ 
						
						/*background-image: url('https://koodariverstas.memorylab.fi/wiki/skins/Tweeki/images/background2.jpg') !important;*/
					...
					.CardContainer{ /**Here is all the cards in main wikibody */
						display:flex;
						width:100%;
						height:auto;
						flex-direction:row;
					...
					.containerContent{ /**All articles card */
						min-height: 300px;
						margin:10px;
						width:450px;
						min-width:350px;
					...
					.containerBeginning{ /**Start of project container */
						margin:10px;
						width:33%;
						min-height:100%;
					}
					.containerDuring{/**During the project card */
						margin:10px;
						width:33%;
						min-height:100%;
					...
					.containerDone{/**End of project card */
						margin:10px;
					...
					.beginCardImage{
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/Beginning.png') !important;  
					...
					.duringCardImage{
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/During.png')!important;  
						background-repeat: no-repeat no-repeat;
						background-size:contain;
						background-position:center;
						max-width:100%;
					...
					.doneCardImage{
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/Done.png') !important;  
						background-repeat: no-repeat no-repeat;
						background-size:contain;
						background-position:center;
						width:100%;
					...
					.subContainer{ /**Here is all cards start, end, during and introduction */
						display:flex;
						width:100%;
						flex-direction:column;
						
					}
					.containerIntroDuction{ /**Introduction card */
						
						width:100%;

					}
					.subcontainerGroup1{/**Here is cards start,during and end */
						display:flex;
						flex-direction:row;

					}
					.subcontainerGroup2{ /**Here is introduction only */
						width:100%
					}
					.introductionCard{ /**This split the indrocution card in half, when screen is bigger */
						display:flex;
						flex-direction: row;
						justify-content:space-between;
					}
					
					.wikiContainer{/**This is just for sure, if more stuff need to add */
						display:flex;
						width:100%;
						justify-content:center;
						
					}
					.wikiSubcontainer{/**This is just for sure, if more stuff need to add */
						justify-content:center;
						width:100%;
						background-color:white;
					}
					...
					.customFooterBlock{/**Footer icons style starts here */
					...
					.euLogo{
						...
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/eu_logo_small.png') !important;  
						background-position:center;
						background-size:contain;
						flex: 0 0 auto;
						height:72px;
					...
					.elyLogo{
						...
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/ely_logo.png') !important; 
						height:56px;
						flex: 0 0 auto;
						width:160px;
						margin:5px;
					...
					.xamkLogo{
						...
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/xamk_logo.png') !important; 
						height:64px;
						flex: 0 0 auto;
						width:160px;
						margin:5px;
					...
					.wikiLogo{
						...
						background-image: url('https://tonymm81.kapsi.fi/mediawiki/skins/Tweeki/images/mediawiki_logo.png') !important; 
						flex: 0 0 auto;
						height:47px;
						width:132px;
						margin:5px;
					}/**footer icon stye ends here */
					@media only screen and (max-width: 990px) { /**mobile view styles */
						#non-mobile{
							display:none;
						}
						.mobileMenu{
						...
						.WikiBodyStylesCustom{/**Wiki body background image and customized wiki main body*/
						...
						.containerContent{/**All articles card */
							...
							.customFooterBlock{ /**Footer icons start here */
								flex-direction:column;
					...
					@media only screen and (max-width: 1340px) and  (min-width:991px) { /**Medium screen rules */
						.CardContainer{/**Here is all the cards in main wikibody */
                            width:100%;
							display:flex;
					...
					@media only screen and (min-width:1760px) {/**Bigger screens rule */
						.CardContainer{/**Here is all the cards in main wikibody */
							width:100%;
						}
						.HeadlinerContainer{
						...
						.subcontainerGroup1{ /**Here is cards */
							width:97%;
			...
			</header><!--Tää tulee otsikon alle kuvan yläpuolelle-->
		<?php }
	}
	...
	public function renderSidebar( $side, $class = '' ) {
		...
		if ( ( true || count( $this->data['view_urls'] ) > 0 || $this->data['isarticle'] ) && $this->checkVisibility( $element ) ) { ?>
			<!-- <?php echo $element;?> -->
				...
				<!--Tässä kohti tuli pitkultainen lokero ja oikee puoli hävis kokonaan-->
	...
	public function renderContent() {
		...
		<div class="mw-body" id="content">
			...
			<div id="bodyContent">
				...
				<?php $this->html( 'bodycontent' ) ?> <!--; echo'<div id="mw-content-text">toi siis älyn ehdottama.<div id="nakyyko" style="display:flex;"><button>perkele</button></div></div>'-->
